...
In dit voorbeeld leert u hoe u een transactiebericht kunt personaliseren door drie velden toe te voegen die u hebt gedefinieerd toen u uw gebeurtenis [maakte: voornaam, laatst geraadpleegd product, totaal aantal karretjes.](../../administration/using/configuring-transactional-messaging.md#use-case--configuring-an-event-to-send-a-transactional-message)

Om dit te doen, zult u [een verpersoonlijkingsgebied](../../designing/using/personalization.md#inserting-a-personalization-field) in de berichtinhoud opnemen.
...
1. Blader door **[!UICONTROL Context]** > **[!UICONTROL Real-time event]** > **[!UICONTROL Event context]** om de aanpassingsvelden op te halen: voornaam, laatst geraadpleegd product, totaal aantal karretjes.
...
### Stap 2: De productlijst {#populating-the-product-listing} invullen
