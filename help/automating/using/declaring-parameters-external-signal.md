...
De eerste stap om een werkstroom met parameters te roepen is hen in een **[!UICONTROL External signal]** activiteit te verklaren.

1. Open de activiteit **[!UICONTROL External signal]** en selecteer vervolgens de tab **[!UICONTROL Parameters]** .
