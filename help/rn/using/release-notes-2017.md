...
* Probleem verholpen in de **[!UICONTROL Load file]**-activiteit die tot fouten kon leiden na het handmatig toevoegen en verwijderen van kolommen in de activiteit.
* De technische workflow van **[!UICONTROL deliverabilityUpdate]** is nu gepland om 2 uur &#39;s nachts, op de server.
...
* Probleem verholpen met de activiteit **[!UICONTROL Reconciliation]**.
* Probleem verholpen met het gebruik van jokertekens in de activiteit **[!UICONTROL File Transfer]**.
...
* Wanneer een verpletterende externe rekening nu gehandicapt is, wordt een waarschuwing getoond in de beïnvloede leveringen (e-mail, SMS en duw) en **Voorproef** is verborgen in deze leveringen.
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   <td> Gecodeerde opgegeven id in gegevensbronnen<br /> </td> 
  ...
  <tr> 
   <td> Direct Mail Channel - Terug naar afzender<br /> </td> 
...
* Probleem verholpen waarbij lijsten met gebruikers konden worden geëxporteerd. Alleen gebruikers met de rol **[!UICONTROL Export]** mogen deze nu doen.

_E-mail, SMS-berichten en direct mail_

* Probleem verholpen met de **updateDeliveryExecInfo**-workflow die de **indicator** voor SMS-leveringen op 0 instelt.
* In **Geavanceerde parameters** van de eigenschappen van het leveringsmalplaatje, **Verpletterend** drop-down lijst tonen nu slechts externe rekeningen die met het type van malplaatjebericht beantwoorden. Een sjabloon voor e-maillevering geeft bijvoorbeeld alleen e-mailexterne accounts weer.
* Probleem verholpen waarbij de e-mailindeling van de voorkeur **[!UICONTROL Text]** is gedefinieerd voor testprofielen.
...
* Probleem verholpen waarbij gebruikers leveringen konden verzenden. Alleen gebruikers met de rol **[!UICONTROL Start deliveries]** mogen deze nu doen. Raadpleeg de [gedetailleerde documentatie](../../sending/using/confirming-the-send.md) voor meer informatie.

_Pushmeldingen_

* Probleem verholpen met de URL **Campagne Tracking Endpoint** die rapportage verhinderde.
...
* In de bovenste balk is de koppeling **[!UICONTROL Timeline]** verwijderd en vervangen door een koppeling naar **[!UICONTROL Programs & Campaigns]**.

_E-mails en SMS-berichten_

* Probleem verholpen waarbij de verkeerde kleur voor de leveringsstatus van **[!UICONTROL Retry in progress]** werd weergegeven. De kleur was grijs in plaats van blauw.
...
* De berekeningen van de **[!UICONTROL Spam]** en **[!UICONTROL Spam rate]**-indicator zijn gewijzigd.
* De **[!UICONTROL Bounce]**-meetwaarden zijn verbeterd voor een nauwkeuriger resultaat.
...
* We hebben het filter **[!UICONTROL by email]** geoptimaliseerd dat in bestemmingspagina&#39;s wordt gebruikt om nieuwe abonnees te verzoenen met databaseprofielen.
...
* Oplossing voor een weergavefout bij het bewerken van een **[!UICONTROL End]**- of **[!UICONTROL External Signal]**-activiteit (alleen in Safari).
* Het foutbericht dat wordt weergegeven tijdens het bewerken van een **[!UICONTROL Read Audience]**-activiteit met een onjuist publiek, is verbeterd.
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> U kunt nu handmatig een aangepaste verzendtijd per ontvanger definiëren - op leveringsniveau of met behulp van een workflow. <br /> Er zijn twee nieuwe opties beschikbaar:  <br /> 
    ...
    </ul> Raadpleeg de <a href="../../sending/using/optimizing-the-sending-time.md">gedetailleerde documentatie</a>.<br /> voor meer informatie. </td> 
  </tr> 
  <tr> 
   ...
   <td> Het pushmeldingskanaal is uitgebreid met verschillende nieuwe mogelijkheden:<br /> 
    ...
    </ul> Raadpleeg de <a href="../../channels/using/about-push-notifications.md">gedetailleerde documentatie</a>.<br /> voor meer informatie. </td> 
  </tr> 
  <tr> 
   <td> Workflows: nieuwe signaalactiviteit<br /> </td> 
   <td> Trigger een werkschema van een andere werkschema gebruikend de nieuwe <span class="uicontrol">Signal</span> activiteit.<br /> Met de capaciteit om één werkschema van een andere te beginnen, kunt u complexere klantenreizen nu steunen. U kunt de reizen van de klant beter controleren en reageren voor het geval er problemen zijn.<br /> Verschillende workflowactiviteiten zijn bijgewerkt:<br /> 
    <ul> 
     <li> <span class="uicontrol"></span> Eindactiviteit: op een nieuw tabblad kunt u een workflow opgeven die wordt geactiveerd nadat deze activiteit is uitgevoerd. </li> 
     <li> <span class="uicontrol">Gegevensactiviteit </span> bijwerken: gebruik de nieuwe lege uitgaande overgang om een  <strong></strong> Eindactiviteit toe te voegen die een andere werkschema teweegbrengt. Lege uitgaande overgangen bevatten geen gegevens en nemen geen overbodige ruimte in het systeem in beslag </li> 
    </ul> Raadpleeg de <a href="../../automating/using/external-signal.md">gedetailleerde documentatie</a>.<br /> voor meer informatie. </td> 
  </tr> 
  <tr> 
   <td> Workflows: nieuw Lezen publiek activiteit<br /> </td> 
  ...
  <tr> 
   <td> Interessentiegegevens<br /> </td> 
   <td> Punten van interessegegevens integreren Adobe Campaign met Adobe Analytics for Mobile. Een merk kan gegevens verzamelen van de mobiele locaties van gebruikers - <strong>Interessepunten</strong> - wanneer gebruikers de app van het merk openen. Hierdoor kan het merk Adobe Campaign-workflows gebruiken om persoonlijke berichten te verzenden op basis van de locatie van de gebruiker. Dit kanaal gebruikt SDK van de Mobiele kerndienst.<br /> Voor deze functie is Analytics for Mobile vereist. Dit is een betaalde oplossing.<br /> Raadpleeg de  <a href="../../integrating/using/about-campaign-points-of-interest-data-integration.md">gedetailleerde documentatie</a> voor meer informatie.<br /> </td> 
  </tr> 
  <tr> 
   <td> REST API's<br /> </td> 
...
* Probleem verholpen waarbij de optie **[!UICONTROL Request confirmation before sending messages]** geselecteerd bleef, zelfs nadat deze was uitgeschakeld en de levering was opgeslagen.
...
* Probleem verholpen waarbij de inhoud van de negatieovergang van een **[!UICONTROL Load file]**-activiteit niet kon worden gelezen.
* Probleem verholpen waarbij werd voorkomen dat omgewisselde kolommen correct in aanmerking werden genomen bij het configureren van een **[!UICONTROL Load file]**-activiteit.
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> Logboeken exporteren, zoals bezorgings- en trackinglogboeken, om deze te verwerken in de rapportage- of BI-gereedschappen van uw voorkeur. U kunt eenvoudige werkschema's met stijgende vragen gebruiken om regelmatige uitvoer van nieuwe logboeken te automatiseren.<br /> Naast de beschikbaarheid van logboekmiddelen van de middelplukker, werden verhogingen aangebracht aan de  <a href="../../automating/using/incremental-query.md">Incrementele </a> vraag en  <a href="../../automating/using/extract-file.md">het </a> dossieractiviteiten van het Uittreksel:<br /> 
    <ul> 
     <li> <span class="uicontrol">Met incrementele </span> query kunt u nu een datumveld gebruiken om nieuwe of bijgewerkte gegevens op te halen. Eerder werden alle resultaten van eerdere executies automatisch uitgesloten, zelfs als deze werden bijgewerkt sinds de laatste executie. </li> 
     <li> <span class="uicontrol">Extraheer </span> filecan exporteert nu labels voor opsommingswaarden in plaats van id's. </li> 
  ...
  <tr> 
   ...
   <td> Marktdeelnemers kunnen nu transactieberichten verzenden op basis van marketingprofielen van klanten. Hierdoor kunnen ze:<br /> 
    ...
    </ul> Raadpleeg de <a href="../../channels/using/editing-transactional-message.md#profile-transactional-message-specificities">gedetailleerde documentatie</a>.<br /> voor meer informatie. </td> 
  </tr> 
  <tr> 
...
* De **[!UICONTROL Access authorization]** opties zijn teruggekeerd aan de eigenschappen van de landingspagina.
...
* Het afwijzingsbestand dat wordt gegenereerd door een **[!UICONTROL Load file]**-activiteit kan nu worden opgehaald in de uitgaande overgang en in de volgende activiteit worden verwerkt. Upload bijvoorbeeld het afgewezen bestand via een SFTP-server met **[!UICONTROL Transfer file]**.
* Probleem verholpen waarbij een gebruiker de populatie van een segment mogelijk niet kon beperken als **[!UICONTROL Temporary resource]** was geselecteerd op het tabblad **[!UICONTROL General]** van **[!UICONTROL Segmentation]**.
...
* Probleem verholpen waarbij **[!UICONTROL Use common columns]** mogelijk niet correct heeft gewerkt in een **[!UICONTROL Union]**-activiteit.
