---
title: Werken met de standaardstructuur voor pushberichten
...
# Werken met de standaardstructuur voor pushberichten {#push-payload}

Met Adobe Campaign kunt u persoonlijke en gesegmenteerde pushmeldingen op mobiele apparaten met iOS en Android verzenden naar mobiele toepassingen (mobiele app).
...
Deze informatie wordt ontvangen door de mobiele toepassingscode in een gebeurtenishandler die aangeeft dat een pushmelding is ontvangen. Wanneer u pushberichten verzendt vanuit Adobe Campaign Standard, bevat de informatie die in de mobiele app is ontvangen mogelijk ook specifieke informatie over Campagnestandaard die kan worden gebruikt om gebruik te maken van bepaalde functies die door de Campagnestandaard worden geboden. Bovendien kan de lading aangepaste gegevens bevatten die door de mobiele app kunnen worden verbruikt.

In dit document wordt de structuur beschreven van de payload die in een mobiele app is ontvangen wanneer een pushmelding naar een app is verzonden vanuit Adobe Campagne Standard.
...
De attributen en hun waarden van de nuttige lading zullen variëren gebaseerd op de configuraties die in de Geavanceerde opties van het pushbericht worden verstrekt. Deze sectie verstrekt ook een afbeelding tussen deze configuraties in de Standaard UI van de Campagne en de attributen in de nuttige lading om te verduidelijken hoe de nuttige lading bij het vormen van een optie in de Norm van de Campagne zal veranderen.
...
**Voorbeeld van Payload verzenden van Adobe Campagne naar Android-app**
...
### Toewijzing tussen de standaardconfiguraties van de Campagne en de Attributen van de Payload {#mapping-payload}
...
* iOS-toepassingen: Sectie **Verre meldingen** verwerken in [Externe meldingen](https://developer.apple.com/library/archive/documentation/NetworkingInternet/Conceptual/RemoteNotificationsPG/HandlingRemoteNotifications.html).
