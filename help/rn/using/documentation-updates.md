...
De integratie met de Verbinding van Gegevens van Adobe Experience Platform en met de dienst van de Doelen van het Publiek zijn nu verouderd. [Meer informatie](deprecated-features.md)

Het gebruik van de SMTP testmodus is gedetailleerd beschreven. [Meer informatie](../../administration/using/configuring-email-channel.md#smtp-test-mode)
