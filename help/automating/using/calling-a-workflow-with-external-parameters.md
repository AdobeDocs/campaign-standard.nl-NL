...
1. Vorm **[!UICONTROL End]** activiteit of de API-aanroep om de parameters te definiëren en de workflow te activeren **[!UICONTROL External signal]** activiteit. Zie [deze pagina](../../automating/using/defining-parameters-calling-workflow.md)
