...
+ Communicatiekanalen {#communication-channels}
   ...
   + Transactieberichten {#transactional-messaging}
      ...
      + Transactievergadering van berichten {#transactional-message-edition}
...
+ Integreren met andere oplossingen {#integrating-with-adobe-cloud}
   ...
   + Campagne en de kernservice Audience Manager of People {#working-with-campaign-and-audience-manager-or-people-core-service}
   ...
   + Campagne en Microsoft Dynamics 365 {#campaign-and-microsoft-dynamics-365}
      ...
      + De integratie-app configureren {#configure-integration-tool}
...
+ Processen en gegevens beheren {#managing-processes-and-data}
   ...
   + Gegevensbeheeractiviteiten {#data-management-activities}
...
+ Ontwikkelen {#developing}
   ...
   + Hoofdlettergebruik: API uitbreiden {#use-case-extending-the-api}
   ...
   + Gebruik gevallen: bronnen uitbreiden {#use-cases-extending-resources}
