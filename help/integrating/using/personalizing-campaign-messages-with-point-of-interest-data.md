...
1. Wanneer u het publiek van de levering definieert, sleept u het element **[!UICONTROL Subscriptions to an application]** naar de werkruimte.
...
1. Klik op **[!UICONTROL Confirm]** om uw publiek op te slaan.
