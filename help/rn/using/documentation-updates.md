...
Een nieuwe sectie is geweest op hoe te met de Bronnen en Doelen van Adobe Experience Platform te werken om gegevens tussen Campaign Standard en Adobe in real time het Platform van de Gegevens van de Klant te delen in tijd (RTCDP). [Meer informatie](../../integrating/using/get-started-sources-destinations.md)
...
De documentatie over afleverbaarheid is bijgewerkt met een nieuw gedeelte over IP-certificering. <!--[Read more](../../sending/using/ip-certification.md)-->
