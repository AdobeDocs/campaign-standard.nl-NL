...
Voordat u op de knop **[!UICONTROL Send]** drukt, moet u controleren of uw bericht optimaal wordt weergegeven op verschillende webclients, webmails en apparaten.

Om dit toe te staan, legt Adobe Campaign de rendering vast en stelt deze beschikbaar in een speciaal rapport. Op deze manier kunt u het verzonden bericht voorvertonen in de verschillende contexten waarin het kan worden ontvangen.
