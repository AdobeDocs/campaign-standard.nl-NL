...
description: Met Adobe Campaign kunt u andere Adobe-oplossingen gebruiken en de verschillende mogelijkheden combineren.
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> Hiermee kunt u rechtstreeks in Adobe Experience Manager e-mailinhoud of formulieren maken die aan de Adobe Campaign-database zijn toegewezen.<br /> </td> 
   <td> 
     <a href="../../integrating/using/integrating-with-experience-manager.md">Werken met Campagne en Experience Manager</a><br/>, Experience Manager en Campaign Standard <a href="https://helpx.adobe.com/experience-manager/6-4/sites/administering/using/campaignstandard.html"></a> integreren <br/>, een e-mail <a href="https://docs.campaign.adobe.com/doc/standard/getting_started/en/ACS_AEM.html">maken met Experience Manager en Campagne</a> 
    </td> 
  </tr> 
  <tr> 
   <td> Target<br /> Classic, standaard<br /> </td> 
   ...
   <td> 
    <a href="../../integrating/using/about-campaign-target-integration.md">Werken met Campagne en Target</a> <br/>, <a href="https://docs.adobe.com/content/help/en/target/using/integrate/campaign-and-target.html">Campagne en Target</a><br/>integreren, E-mailafbeeldingen <a href="https://helpx.adobe.com/marketing-cloud/how-to/email-marketing.html">aanpassen in Real-Time</a> video (stap 3)
    </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td> Adobe Audience Manager en de kerndienst van Mensen (Profielen &amp; Publiek)<br /> </td> 
  ...
  <tr> 
   ...
   <td> Hiermee kunt u elementen uit uw Adobe Experience Cloud-bibliotheek invoegen in e-mails en landingspagina's die in Adobe Campaign zijn gemaakt.<br /> </td> 
  ...
  <tr> 
   ...
   <td> <a href="../../integrating/using/about-campaign-points-of-interest-data-integration.md">Locatiegebaseerde marketingberichten verzenden met Campagne en interessepunten</a> (Analytics for Mobile)<br /> </td> 
  </tr> 
  <tr> 
   ...
   <td> 
    <a href="../../integrating/using/about-adobe-experience-cloud-triggers.md">Experience Cloud-triggers gebruiken in Campaign Standard</a><br/>, <a href="../../integrating/using/abandonment-triggers-use-cases.md">Abandection Triggers-Campaign-gebruiksgevallen</a><br/>, <a href="https://helpx.adobe.com/marketing-cloud/how-to/email-marketing.html">Trigger Remarketing-berichten activeren op video over siteactiviteiten</a> (stap 2)
    </td> 
  </tr> 
  <tr> 
