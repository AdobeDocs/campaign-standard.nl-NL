...
* **weet welk malplaatje met de integratie te gebruiken**
  ...
  Voor meer informatie over malplaatjes, verwijs naar deze [&#x200B; pagina &#x200B;](https://experienceleague.adobe.com/docs/experience-manager-65/developing/platform/templates/templates.html?lang=nl-NL).
...
* **zorg ervoor Externalzer tijdens implementatie** werd gevormd
  ...
  Leren hoe te om Externalzer te vormen, verwijs naar deze [&#x200B; pagina &#x200B;](https://experienceleague.adobe.com/docs/experience-manager-65/developing/platform/externalizer.html?lang=nl-NL).
...
* **organiseer uw e-mailmalplaatjes om misbruik te vermijden.**
  ...
  Voor meer informatie over malplaatjes, verwijs naar deze [&#x200B; pagina &#x200B;](https://experienceleague.adobe.com/docs/experience-manager-65/developing/platform/templates/templates.html?lang=nl-NL#template-availability).
...
Leren hoe te opstellings segmentatie in Adobe Experience Manager en hoe te om e-mail met gerichte inhoud tot stand te brengen, verwijs naar deze [&#x200B; pagina &#x200B;](https://experienceleague.adobe.com/docs/experience-manager-65/authoring/aem-adobe-campaign/target-adobe-campaign.html?lang=nl-NL#setting-up-segmentation-in-aem).
