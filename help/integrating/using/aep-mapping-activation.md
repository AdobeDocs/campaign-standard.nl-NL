...
Wanneer de toewijzingsdefinitie is voltooid, kunt u de toewijzing publiceren. Na de implementatiestap wordt de gegevensreplicatie tussen Campaign Standard en Adobe Experience Platform automatisch gestart. U kunt de replicatie op elk gewenst moment stoppen door op de knop **[!UICONTROL Stop]** te klikken.
...
* **[!UICONTROL Created]**: Er wordt een gegevensinnametaak gemaakt en de gegevensinvoer wordt uitgevoerd.
...
1. Voeg de **[!UICONTROL Profile Privacy]** -mix toe aan het schema.
