---
title: Interfacebeschrijving
description: '"Leer hoe u door de werkruimte van Adobe Campagne kunt navigeren en deze kunt gebruiken: homepage, bovenste balk, geavanceerde menu''s en actiebalken."'
...
* Met de **[!UICONTROL Customer profiles]** kaart gaat u rechtstreeks naar de lijst met profielen. Hier kunt u de gebeurtenissen raadplegen die betrekking hebben op elk van de profielen in de lijst. Zie Profielen [](../../audiences/using/about-profiles.md)beheren.
...
* **[!UICONTROL Test profiles]** - Raadpleeg voor meer informatie de sectie Testprofielen [](../../audiences/using/managing-test-profiles.md) beheren.
