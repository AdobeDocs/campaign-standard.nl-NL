...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   <td> Profiel<br /> </td> 
   <td> Hiermee worden de velden voor een out-of-the-box en aangepast profiel die zijn gemaakt tijdens de uitbreiding van de profielbron opnieuw ingedeeld. Meer informatie hierover verwijst naar <a href="../../developing/using/key-steps-to-add-a-resource.md">page</a> of dit <a href="../../reporting/using/creating-a-custom-profile-dimension.md">voorbeeld</a>.<br /> De gegevens voor deze dimensie worden opgehaald zodra de aangepaste bron die is gekoppeld aan het profielveld is gepubliceerd.<br /> </td> 
  </tr> 
  <tr> 
