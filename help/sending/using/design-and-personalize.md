...
Probeer bij het ontwerpen van de inhoud van uw bericht algemene problemen te vermijden die ertoe kunnen leiden dat u de levering niet kunt uitvoeren. De meeste tijd, de mogelijke fouten zijn verwant met [&#x200B; verpersoonlijking &#x200B;](../../designing/using/personalization.md), die wanneer [&#x200B; het gebruiken van een bestaande inhoud &#x200B;](../../designing/using/using-existing-content.md) - en [&#x200B; die een inhoud van HTML &#x200B;](../../designing/using/using-existing-content.md#converting-an-html-content) omzetten - en [&#x200B; beelden &#x200B;](../../designing/using/images.md) formatteert.
...
De grondbeginselen van Personalization worden voorgesteld in [&#x200B; deze sectie &#x200B;](../../designing/using/personalization.md).
...
Voor meer op dynamische inhoud, verwijs naar [&#x200B; deze sectie &#x200B;](../../designing/using/personalization.md#defining-dynamic-content-in-an-email).

**Uiteinden** - voorproef uw e-mail met verschillende testprofielen om ervoor te zorgen dat uw dynamische inhoud correct is gevormd.
...
Het werk op de [&#x200B; onderwerpregel &#x200B;](../../designing/using/subject-line.md) om open tarieven te verbeteren:
...
Neem altijd een koppeling naar een spiegelpagina op. De voorkeurspositie boven aan het e-mailbericht. [&#x200B; Leer meer &#x200B;](../../designing/using/personalization.md#adding-a-content-block)

### Koppeling met abonnement opheffen

De koppeling om uw abonnement op te zeggen is essentieel. Het formulier moet zichtbaar en geldig zijn en moet functioneel zijn. Leer unsubscription verbindingsrichtlijnen [&#x200B; in deze sectie &#x200B;](../../designing/using/personalization.md#about-targeting-dimension).
...
Om prestaties of leveringsproblemen te vermijden, is de geadviseerde maximumgrootte van een e-mail ongeveer **35KB**.

Houd rekening met het volgende om uw e-mailadres onder de limiet te houden:

* Overbodige of ongebruikte stijlen verwijderen

* Beweeg enkele e-mailinhoud naar a [&#x200B; landende pagina &#x200B;](../../channels/using/getting-started-with-landing-pages.md)

* Miniatuur uw code

Zorg ervoor om het even welke veranderingen vóór de definitieve verzending te testen.

In Adobe Campaign, wordt de standaardmaximumgrootte van een e-mail geplaatst aan **100MB**. <!--This limit enables to prevent any error that could indefinitely increase the size of an email, which can lead to a system crash.-->
...
Adobe raadt aan de standaardwaarde voor de maximale berichtgrootte te handhaven. Nochtans, kan deze waarde in de **[!UICONTROL Maximum message size]** optie, door **[!UICONTROL Administration]** > **[!UICONTROL Application settings]** > **[!UICONTROL Options]** menu, door [&#x200B; functionele beheerders &#x200B;](../../administration/using/users-management.md#functional-administrators) slechts worden veranderd.
...
Standaard voldoet het aantal tekens in een SMS aan de GSM-standaarden (Global System for Mobile Communications). SMS-berichten die gebruikmaken van GSM-codering mogen maximaal 160 tekens bevatten, of 153 tekens per SMS voor berichten die in meerdere onderdelen worden verzonden.
...
Leer meer [&#x200B; in deze sectie &#x200B;](../../administration/using/configuring-sms-channel.md#sms-encoding--length-and-transliteration).
...
* Campagne-e-mail Designer wordt geleverd met responsieve ontwerpsjablonen voor mobiele apparaten. Leer meer [&#x200B; in deze pagina &#x200B;](../../designing/using/using-reusable-content.md#content-templates).
...
In de e-mailontwerper kunt u met de knop **[!UICONTROL Preview]** de rendering van elke inhoud voor een ontvanger bekijken. De verpersoonlijkingsgebieden en de voorwaardelijke elementen van inhoud worden vervangen met de overeenkomstige informatie voor het geselecteerde profiel. [&#x200B; Leer meer &#x200B;](../../sending/using/previewing-messages.md)
